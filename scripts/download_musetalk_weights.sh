...
echo "Downloading MiniCPM-o-2_6-int4 weights to $MUSETALK_ROOT_DIR/s3fd-619a316812..."
git clone https://www.modelscope.cn/HumanAIGC-Engineering/s3fd-619a316812.git $MUSETALK_ROOT_DIR/s3fd-619a316812
